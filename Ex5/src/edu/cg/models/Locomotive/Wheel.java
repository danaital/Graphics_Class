...
public class Wheel implements IRenderable {
    ...
    public void render() {
        glPushMatrix();
        glRotated(90, 0, 1, 0);
        glTranslated(0, 0, -Specification.WHEEL_RADIUS * .5);
        Materials.setMaterialWheelTire();
        new Cylinder().draw((float) Specification.WHEEL_RADIUS, (float) Specification.WHEEL_RADIUS, (float) Specification.WHEEL_RADIUS, 20, 1);
        this.drawRims();
